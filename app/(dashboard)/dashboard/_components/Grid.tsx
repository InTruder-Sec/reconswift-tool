  ...
  return (
    <tr
      className={`text-sm hover:bg-slate-200 ${
        props.key % 2 === 0
          ? "bg-black dark:bg-reconswiftDarkPrimary"
          : "bg-reconswiftPrimary dark:bg-reconswiftDarkPrimary"
      }`}
    >
  ...
  return (
    <div className="w-11/12 mx-auto mt-8 overflow-scroll sm:overflow-hidden">
      <table className="table-auto w-full ">
        <thead>
          <tr className="text-left bg-reconswiftSecondary dark:bg-reconswiftDarkSecondary rounded-t-lg">
            <th className="px-4 py-4 border-b-2 border-r-2 border-gray-600 dark:text-white rounded-tl-lg">
              Target URL
            </th>
            <th className="px-4 py-4 border-b-2 border-r-2 border-gray-600">
              Scan ID
            </th>
            <th className="px-4 py-4 border-b-2 border-gray-600 rounded-tr-lg">Status</th>
          </tr>
        </thead>
        <tbody>
          {props.isLoading ? (
