...
async function Home() {
  return (
    <div className="bg-reconswiftPrimary dark:bg-reconswiftDarkSecondary">
      <Navbar />
      <div className="w-11/12 md:w-9/12 sm:w-10/12 mx-auto">
        <div className="text-5xl font-normal mx-auto mt-20 leading-tight ">
        ...
        <Link href="/dashboard/home">
          <Button className="mt-10 font-medium text-sm md:text-lg duration-200 p-7 bg-reconswiftThemeColor dark:bg-reconswiftThemeColorDark hover:bg-reconswiftThemeColorSecondary dark:hover:bg-reconswiftThemeColorDarkSecondary">
            Get Started
          </Button>
        </Link>
      </div>
      <div className="w-11/12 md:w-9/12 sm:w-10/12 mx-auto mt-20 ">
        <div className="w-full shadow-xl rounded-lg shadow-reconswiftThemeColor dark:shadow-reconswiftThemeColorDark">
          <ThemeImage />
        </div>
      </div>
      <div className="w-full flex bg-gradient-to-r from-reconswiftThemeColor to-reconswiftThemeColorSecondary dark:from-reconswiftDarkSecondary text-foreground  text-lg py-10 -mt-20 pb-24 dark:mt-10 dark:pt-0">
      ...
      <div className="w-11/12 md:w-9/12 sm:w-10/12 mx-auto my-24 ">
        ...
        <ClickHandlers
          ...
          styles="my-16 float-right duration-200 dark:bg-reconswiftThemeColorDark dark:text-black font-semibold text-base p-3 px-5 text-white cursor-pointer bg-blue-700 hover:bg-sky-600 hover:text-white rounded-lg "
        />
      </div>
      <div className="w-full bg-black text-foreground pt-32 mt-52">
        <div className="w-11/12 md:w-9/12 sm:w-10/12 mx-auto pb-20">
          ...
          <Link href="/signup">
            <Button className="mt-10 text-xl md:text-2xl font-semibold  p-8  text-white bg-blue-700 dark:bg-reconswiftThemeColorDark dark:text-black duration-500 hover:bg-white hover:text-black">
              Get Started Now
            </Button>
          </Link>
        </div>
